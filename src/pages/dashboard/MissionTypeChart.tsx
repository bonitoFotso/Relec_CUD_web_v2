...
const MissionTypeChart: React.FC<ChartProps> = ({ data }) => {
  ...
  return (
    <div className="h-full p-3 bg-white dark:bg-gray-950 px-3 py-3 rounded-lg shadow-md">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold ">
          Répartition des missions par type
        </h2>
        <div className="text-xs font-medium p-2  bg-blue-100 text-blue-800 rounded-full">
      ...
      {chartData.length > 1 && (
        <CustomLegend data={chartData as PieChartData[]} />
      )}
